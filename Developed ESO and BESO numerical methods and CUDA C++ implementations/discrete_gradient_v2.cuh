void discrete_gradient_numerical_method_v2()
{
	...
	cudacall(cudaMalloc((void**)&dev_exclusion_zone, N * N * sizeof(bool)));
	...
	get_exclusion_zone_v1((bool *)dev_exclusion_zone, (const bool *)dev_mask, spread, blocks, threads);
	target_function_indexed((bool *)dev_exclusion_zone, (cuComplex *)dev_solution, (unsigned int *)dev_index_of_max, (float *)&h_instensity_max);
	...
	do
	{
		...
		while (h_check_sum != N * N)
		{
			...
			get_neighbour_indices_for_gradient_v2 <<<  blocks, threads >>> ((bool *)dev_mask, (float *)dev_gradient, (unsigned int *)dev_check_sum, (unsigned int *)dev_index_of_max, spread);
	...
	cudacall(cudaFree((bool *)dev_exclusion_zone));
